    ...
    <form class="edit_form" method="post" enctype="multipart/form-data">
        ...
        <div class="edit_inputs">
            ...
            <select class="available_input" name="available" id="available">
                <option value="1" <?php echo ($book->getAvailable() === true) ? 'selected' : ''; ?>>disponible</option>
                <option value="0" <?php echo ($book->getAvailable() === false) ? 'selected' : ''; ?>>non disponible</option>
            </select>
